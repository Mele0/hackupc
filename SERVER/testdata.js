...
connection.connect(function(err){
    if(active){
        ...
        // var sqlbib_hours = "CREATE TABLE biblio_hours (id VARCHAR(255), hours FLOAT(24), day DATE)";
        // connection.query(sqlbib_hours, function (err, result) {
        //     if (err) throw err;
        // });

        var sqlbib_tstudy = "CREATE TABLE biblio_study(id VARCHAR(255), hours FLOAT(24), day DATE)";
        connection.query(sqlbib_tstudy, function (err, result) {
            if (err) throw err;
        });
        ...
        //     if (err) throw err;
        // });
        // var sqlbib = "INSERT INTO biblio (id,entrance,end,day) VALUES ('49271168Q','18:00:00','20:00:00','2022-04-01'),('49271168Q','14:32:00','17:00:00','2022-04-04'),('49271168Q','15:32:00','20:10:00','2022-04-01'),('49271168Q','15:17:00','19:09:00','2022-04-14')";
        // connection.query(sqlbib, function (err, result) {
        //     if (err) throw err;
        // });
        // var sqlbib_hours = "INSERT INTO biblio_hours (id,hours) VALUES ('49271168Q',40),('49272268Q',12),('49273368Q',16),('49274468Q',12)";
        // connection.query(sqlbib_hours, function (err, result) {
        //     if (err) throw err;
        // });
        var sqlbib_tstudy = "INSERT INTO biblio_study (id,hours,day) VALUES ('49271168Q',2,'2022-04-01'),('49271168Q',3, '2022-04-04'),('49271168Q',5, '2022-04-02'),('492711   68Q',4,'2022-04-14')";
        connection.query(sqlbib_tstudy, function (err, result) {
            if (err) throw err;
        });
